<template>
  <div class="card">
    ...
    >
      ...
      <el-table-column label="Unique ID" prop="id" min-width="140px" sortable>
      </el-table-column>
      ...
      <el-table-column label="Channels" prop="channels" min-width="140px" sortable>
      </el-table-column>
